...
func TestValueAsStr(t *testing.T) {
	...
	os.Unsetenv(envVarPrefix + "_TEST_STR_VALUE")
	...
	os.Setenv(envVarPrefix+"_TEST_STR_VALUE", "hello")
...
func TestGetEnvVar(t *testing.T) {
	...
	os.Setenv(envVarPrefix+"_TEST_STR_NEW", "isset")
	assert.Equal(t, "isset", cfg.getEnvVar("_TEST_STR_NEW", "isset"), "_TEST_STR_NEW")
	os.Unsetenv(envVarPrefix + "_TEST_STR_NEW")
